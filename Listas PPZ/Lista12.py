...
def zf(n):
  n = str(n)[::-1]   # ele vai começar a contar de trás para frente
  sum = 0
  i = 0                   
  while '0' == n[i]:  # enquanto ele for lendo e vendo que o índice de trás
      sum += 1        # para frente é '0', ele soma mais 1 no sum e no índice
      i += 1
  return sum
